<template>
  <div class="container">
    <detail-title :title="title" :isHidden="true"></detail-title>
...
export default {
  ...
  mounted () {
    ...
    document.querySelector('#coursesTable').style.height = document.querySelector(
      '.tabs-bar'
    )
      ? document.querySelector('.my-tabs').offsetHeight -
        document.querySelector('.tabs-bar').offsetHeight -
        40 + 'px'
      : document.querySelector('.my-tabs').offsetHeight - 40 + 'px'
