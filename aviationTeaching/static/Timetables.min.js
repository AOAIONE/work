;(function (global) {
  ...
  Timetables.prototype = {
    _init: function (option) {
      ...
      courseWrapper.style.borderTop = '1px solid #dbdbdb'
      // courseWrapper.style.borderBottom = '1px solid #dbdbdb'
      ...
      week.forEach(function (item, index) {
        ...
        //重新设置内容
        dayItem.innerText = day[index]
        dayItem.style.fontWeight = 'bold'
        weekli.innerText = item
        //修改样式
        weekItem.style.lineHeight = (10*dpr) + 'px'
      ...
      timetable.forEach(function (values, index) {
        ...
        courseItems.style.minHeight = Gheight-1 + 'px'
        courseItems.style.borderTop = '1px dashed #f7f7f7'
        ...
        values.forEach(function (item, i) {
          ...
          if (merge && listMerge[i][index].length > 1) {
            ...
            mergeDom.style.display = 'inline-Block'
            mergeDom.style.wordWrap = 'break-word'
      ...
      var coursesHeadDomHeight = document.querySelector('.Courses-head')
        .offsetHeight
      ...
      deepCopyTimetableType.forEach(function (item, index) {
        ...
        if (typeof item[0] === 'object') {
          for (var v in item[0]) {
            ...
            //修改样式
            handItem.style.lineHeight = '50px'
            handItem.style.fontSize = '12px'
        ...
        //修改li样式
        handItem.style.borderTop = '1px dashed #f7f7f7'
